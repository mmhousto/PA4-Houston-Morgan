...
if __name__ == "__main__":
    ...
    # data set shown in figure 7.1
    print("Data Set shown in Fig7.1"); test(data = Data_from_file('fig7.1.csv', num_train=16, target_index=-1))
    # train 16 because should be 80-20 training-testing respectively of 20 total examples.
